...
extern int nrn_get_mechtype();
 ...
 "setdata_ixx", _hoc_setdata,
 "exptable_ixx", _hoc_exptable,
 "evaluate_fct_ixx", _hoc_evaluate_fct,
 0, 0
};
#define _f_exptable _f_exptable_ixx
#define exptable exptable_ixx
 extern double _f_exptable();
 extern double exptable();
 /* declare global and static user variables */
#define ekk ekk_ixx
 double ekk = -65;
#define tau_m tau_m_ixx
 double tau_m = 1;
#define taumax taumax_ixx
 double taumax = 10;
#define usetable usetable_ixx
 double usetable = 1;
 ...
 "ekk_ixx", &ekk_ixx,
 "taumax_ixx", &taumax_ixx,
 "tau_m_ixx", &tau_m_ixx,
 "usetable_ixx", &usetable_ixx,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 ixx /home/douglas/Documents/epfl/1st-master/neural-networks/miniproject/source/i686/I_x2.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double *_t_exptable;
static int _reset;
static char *modelname = "Cortical I xx subthreshold current ";
...
static int  evaluate_fct (  _lv )  
	double _lv ;
 {
   m_inf = exptable ( _threadargscomma_ _lv ) ;
    return 0; }
...
double _f_exptable (  _lx )  
 ...
 if ( ( _lx > - 40.0 ) ) {
     ...
     _lexptable = - 1.0 * ( 1.0 - ( 1.0 / ( 1.0 + exp ( ( _lx + 50.0 ) / 5.0 ) ) ) ) ;
     }
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 45 in file I_x2.mod:\n	SOLVE states METHOD euler\n"); nrn_complain(_p); abort_run(error);}
