...
extern int nrn_get_mechtype();
 ...
 "setdata_ix", _hoc_setdata,
 "exptable_ix", _hoc_exptable,
 "evaluate_fct_ix", _hoc_evaluate_fct,
 0, 0
};
#define _f_exptable _f_exptable_ix
#define exptable exptable_ix
 extern double _f_exptable();
 extern double exptable();
 /* declare global and static user variables */
#define ekk ekk_ix
 double ekk = -70;
#define tau_m tau_m_ix
 double tau_m = 1;
#define taumax taumax_ix
 double taumax = 10;
#define usetable usetable_ix
 double usetable = 1;
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 ix /home/douglas/Documents/epfl/1st-master/neural-networks/miniproject/source/i686/I_x1.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double *_t_exptable;
static int _reset;
static char *modelname = "Cortical I x  subthreshold current";
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 45 in file I_x1.mod:\n	SOLVE states METHOD euler\n"); nrn_complain(_p); abort_run(error);}
