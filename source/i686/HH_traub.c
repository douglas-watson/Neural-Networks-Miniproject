	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 6);
 	...
 	ivoc_help("help ?1 hh2 /home/douglas/Documents/epfl/1st-master/neural-networks/miniproject/mod_file_neuron_miniproject/i686/HH_traub.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 68 in file HH_traub.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
